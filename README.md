# Getting Started Login and Sign Up App
...
7. After successfully creating the first user, click Sign In link in the Navigation bar.

8. Now use the email address & password of the created user to login to the front app.
